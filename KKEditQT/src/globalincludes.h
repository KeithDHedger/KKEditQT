...
#define OPENALLMENUNAME "openallmenu"
...
//file
enum {NEWMENUITEM=0x8000,OPENMENUITEM,OPENALLMENUITEM,HEXDUMPMENUITEM,NEWADMINEDMENUITEM,NEWEDMENUITEM,MANPAGEEDMENUITEM,SAVEMENUITEM,SAVEASMENUITEM,SAVEALLMENUITEM,SAVESESSIONMENUITEM,RESTORESESSIONMENUITEM,PRINTMENUITEM,CLOSEMENUITEM,CLOSEALLMENUITEM,REVERTMENUITEM,EXPORTTOPDFMENUITEM,IMPORTFROMPDFMENUITEM,QUITMENUITEM};
//edit
...
//plugins
//help
enum {ABOUTMENUITEM=0xe000,HELPMENUITEM};
...
enum {FUNCTIONCOMBO=0,THEMECOMBO,FONTNAMECOMBO,PREFSTERMCOMMAND,PREFSPRINTCOMMAND,PREFSPAGESIZE,PREFSROOTCOMMAND,PREFSCURRENTFONT,SHORTCUTSCOMBO,PREFSCTAGSEXCLUDE,MAXPREFSOTHERWIDGETS};
